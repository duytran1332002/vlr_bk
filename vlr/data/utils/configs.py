...
class SlicingTaskConfig(TaskConfig):
    ...
    """
    task: str = "slice"
    src_repo_id: str = "fptu/vietnamese-speaker-video"
    dest_repo_id: str = "fptu/vietnamese-speaker-clip"
...
class CroppingTaskConfig(TaskConfig):
    ...
    """
    task: str = "crop"
    src_repo_id: str = "fptu/vietnamese-speaker-clip"
    dest_repo_id: str = "fptu/vietnamese-speaker-lip-clip"
...
class DenoisingTaskConfig(TaskConfig):
    ...
    """
    task: str = "denoise"
    src_repo_id: str = "fptu/vietnamese-speaker-lip-clip"
    dest_repo_id: str = "fptu/denoised-vietnamese-audio"
...
class TranscribingTaskConfig(TaskConfig):
    ...
    """
    task: str = "transcribe"
    src_repo_id: str = "fptu/denoised-vietnamese-audio"
    dest_repo_id: str = "fptu/purified-vietnamese-audio"
